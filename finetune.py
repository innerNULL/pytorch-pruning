...
class FilterPrunner:
	...
	for layer, (name, module) in enumerate(self.model.features._modules.items()):
	    """ layer is int generated by enumerate(). """
	    """
	    first x will be the the batch input from training data，but with the 
	    iteration along the internal layers, x will be dynamic assigned by the 
	...
	"""
	values is a 1 * c tensor, c represents current layers channel number
	"""
	values = \
	...
	""" append the values to cache zone """
